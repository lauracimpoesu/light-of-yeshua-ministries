...
const events = [
  {
    ...
    description: "Learn effective techniques for sharing the Gospel on the streets.",
    attendees: 28
  },
  {
    title: "Mission Trip: London",
        ...
        >
          ...
          <div className="max-w-3xl mx-auto mb-12">
            <p className="text-lg text-gray-700 dark:text-gray-300 text-center">
              Join us for our upcoming events and outreach opportunities. Be part of 
              taking the light of Yeshua to the nations.
            </p>
          </div>
                ...
                <Card className="overflow-hidden hover:shadow-xl transition-all duration-500">
                  <CardContent className="p-6">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <Button variant="outline" className="hover:bg-ministry-purple/10 hover:text-ministry-purple transition-all duration-500">
                        Join Event
                      </Button>
                    </div>
                  </CardContent>
